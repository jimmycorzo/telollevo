...
export class SeoService implements OnDestroy {
  ...
  canonicalUrl = 'https://telollevo-App.com';
    ...
    this._routerSubscription = this.router.events
      ...
      .subscribe(event => {
        ...
        if (routeData && routeData.seo) {
          ...
          currentRouteSeoData.title = 'Te Lo Llevo';
          currentRouteSeoData.description = 'Te Lo Llevo - por Sofcor';
          currentRouteSeoData.keywords = '';
          currentRouteSeoData.image = 'https://s3-us-west-2.amazonaws.com/sofcor/imgs/logofacebook.png';
